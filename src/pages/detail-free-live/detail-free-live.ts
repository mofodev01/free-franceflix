...
@Component({
  selector: 'page-detail-free-live',
  templateUrl: 'detail-free-live.html',
})
export class DetailFreeLivePage {
  title:any;
  categorie:any;
  id:any;
  countries: any;
...
/*----------------------------*/
 ...
 /**----------------------------------------- */
  ...
  /**----------------------------------------- */
    ...
    this.JsonDataProvider.getLivefree(this.id,this.categorie)
             .subscribe(
               countries =>{
